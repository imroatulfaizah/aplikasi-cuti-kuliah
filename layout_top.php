...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti UNIKAMA - <?php echo $pagedesc ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>Universitas Kanjuruhan Malang</strong></div>
					<div class="clear-both"></div>
				</a>
				<a class="navbar-brand visible-xs" href="index.php">
					<img src="libs/images/isk-logo.jpg" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>UNIKAMA</strong></div>
					<div class="clear-both"></div>
				</a>
			</div><!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>Universitas Kanjuruhan Malang</b></h4>
                        ...
                        <!-- open <li> tag generated with php, see line 134-139 -->
							<a href="#"><i class="fa fa-group fa-fw"></i>&nbsp;Data Akses<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Karyawan") {
										echo '<li><a href="karyawan.php" class="active">Data Akses</a></li>';
									}
									else {
										echo '<li><a href="karyawan.php">Data Akses</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
