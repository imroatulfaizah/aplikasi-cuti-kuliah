...
<body style="background-color: #f1f4f7">
				...
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 3px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05); box-shadow: 0 1px 1px rgba(0,0,0,.05)">
					<div class="row">
						<div class="col-lg-12">
							...
							<h3 class="text-center">Sistem Informasi Pengajuan Cuti Online<br/> 
							<b>Universitas Kanjuruhan Malang</b></h3>
						</div>
					</div><!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
								...
								<div class="panel-body">
									<form action="login_auth.php" method="post">
										...
										<div class="form-group">
											...
											<option value="Mng">Wakil Rektor 3</option>
											<option value="Spv">Dekan Fakultas</option>
											<option value="Lead">Kepala Prodi</option>
											<option value="Pgw">Mahasiswa</option>
											</select>
										</div>
										<div class="form-group">
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom footer-bottom">
		<div class="container text-center">
			<p class="text-center" style="color: #D1C4E9; margin: 0 0 5px; padding: 0"><small>Sistem Informasi Pengajuan Cuti Online Universitas Kanjuruhan Malang</small></p>
		</div>
	</div><!-- /.footer-bottom -->
